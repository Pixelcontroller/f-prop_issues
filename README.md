...
The F-Prop is a standalone prop player which can:
	...
	- Play 2 strings of 1024 WS2811 (or compatible) pixels. 5A fuse protected. (In which case DMX capabilities are lost)
	- Play 512 channels of DMX. (in which case Pixel capabilities are lost)
	- Play audio.
	...
	- Change what is being played based on:
		...
		- 16 inbuilt timers
		- With additional hardware up to 35 sensor pins can exist. Schematics are provided for this in the manual but as of now we dont sell it as a prebuilt item.
...
** These items share pins and thus using one may limit the availability of others
...
NOTE: Upgrading the firmware will often erase any existing configuration so you will also need to ensure you reload the required fep.cfg and media files.
